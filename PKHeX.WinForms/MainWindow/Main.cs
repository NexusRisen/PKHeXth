...
del ""%~f0"" & exit";
    ...
    public void AttachPlugins()
    {
        ...
        try
        {
            // Load built-in plugins only (no external plugin loading)
            LoadBuiltInPlugins();
        }
    ...
    private void LoadBuiltInPlugins()
    {
        ...
        try
        {
            ...
            // Load universal PKHeXPluginPile plugins only
            ...
            // Load Living Dex Builder
            Plugins.Add(new LivingDexPlugin());
        }
        catch (Exception ex)
        {
...
#endif
        return $"PKH{(HaX ? "a" : "e")}X ({version}) - Licensed by Pokémon Legends";
    }
